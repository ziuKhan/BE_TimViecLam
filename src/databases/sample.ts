...
export const INIT_PERMISSIONS = [
  ...
  {
    _id: '648ad622dafdb9754f40b8d2',
    name: 'Fetch subscribers by id',
    apiPath: '/api/v1/subscribers/:id',
    method: 'GET',
    module: 'SUBSCRIBERS',
    createdBy: {
      _id: '66becb545d7d44613ba36da5',
      email: 'admin@gmail.com',
    },
    isDeleted: false,
    deletedAt: null,
